...
if __name__ == "__main__":
    ...
    conn_prod = psycopg2.connect(
        f"host={DB_HOST} dbname={DB_NAME} port={DB_PORT} " f"user={DB_USER} password={DB_PASSWORD}"
    )

    conn_local = psycopg2.connect(f"host=127.0.0.1 dbname=mastersber port=5432 " f"user=postgres password=postgres")
